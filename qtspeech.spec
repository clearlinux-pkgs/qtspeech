...
Source0  : http://download.qt.io/official_releases/qt/5.10/5.10.0/submodules/qtspeech-everywhere-src-5.10.0.tar.xz
...
%prep
%setup -q -n qtspeech-everywhere-src-5.10.0
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtTextToSpeech/5.10.0/QtTextToSpeech/private/qtexttospeech_p.h
/usr/include/qt5/QtTextToSpeech/5.10.0/QtTextToSpeech/private/qvoice_p.h
...
/usr/lib64/libQt5TextToSpeech.so.5.10
/usr/lib64/libQt5TextToSpeech.so.5.10.0
