...
Source0  : http://download.qt.io/official_releases/qt/5.11/5.11.1/submodules/qtspeech-everywhere-src-5.11.1.tar.xz
...
%prep
%setup -q -n qtspeech-everywhere-src-5.11.1
...
%install
export SOURCE_DATE_EPOCH=1530978743
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtTextToSpeech/5.11.1/QtTextToSpeech/private/qtexttospeech_p.h
/usr/include/qt5/QtTextToSpeech/5.11.1/QtTextToSpeech/private/qvoice_p.h
...
/usr/lib64/libQt5TextToSpeech.so.5.11.1
