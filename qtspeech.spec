...
Version  : 5.15.17
Release  : 27
URL      : https://download.qt.io/official_releases/qt/5.15/5.15.17/submodules/qtspeech-everywhere-opensource-src-5.15.17.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.15/5.15.17/submodules/qtspeech-everywhere-opensource-src-5.15.17.tar.xz
...
%prep
%setup -q -n qtspeech-everywhere-src-5.15.17
cd %{_builddir}/qtspeech-everywhere-src-5.15.17
...
ASFLAGS="$CLEAR_INTERMEDIATE_ASFLAGS"
LDFLAGS="$CLEAR_INTERMEDIATE_LDFLAGS"
export SOURCE_DATE_EPOCH=1748668644
rm -rf %{buildroot}
...
/usr/lib64/libQt5TextToSpeech.so.5.15.17
