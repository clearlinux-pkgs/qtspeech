...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.2/submodules/qtspeech-everywhere-src-5.12.2.tar.xz
...
%prep
%setup -q -n qtspeech-everywhere-src-5.12.2
...
%install
export SOURCE_DATE_EPOCH=1552686080
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtTextToSpeech/5.12.2/QtTextToSpeech/private/qtexttospeech_p.h
/usr/include/qt5/QtTextToSpeech/5.12.2/QtTextToSpeech/private/qvoice_p.h
...
/usr/lib64/libQt5TextToSpeech.so.5.12.2
