...
Version  : 5.14.1
Release  : 16
URL      : https://download.qt.io/official_releases/qt/5.14/5.14.1/submodules/qtspeech-everywhere-src-5.14.1.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.14/5.14.1/submodules/qtspeech-everywhere-src-5.14.1.tar.xz
...
%prep
%setup -q -n qtspeech-everywhere-src-5.14.1
cd %{_builddir}/qtspeech-everywhere-src-5.14.1
...
%install
export SOURCE_DATE_EPOCH=1580242055
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtspeech
cp %{_builddir}/qtspeech-everywhere-src-5.14.1/LICENSE.FDL %{buildroot}/usr/share/package-licenses/qtspeech/61907422fefcd2313a9b570c31d203a6dbebd333
cp %{_builddir}/qtspeech-everywhere-src-5.14.1/LICENSE.GPLv2 %{buildroot}/usr/share/package-licenses/qtspeech/78287b08861c4e3c6393a7873c08bc3b8005d02c
cp %{_builddir}/qtspeech-everywhere-src-5.14.1/LICENSE.LGPLv3 %{buildroot}/usr/share/package-licenses/qtspeech/d8c5ba35d57eceb2e56ace166048cb901a2d12ed
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtTextToSpeech/5.14.1/QtTextToSpeech/private/qtexttospeech_p.h
/usr/include/qt5/QtTextToSpeech/5.14.1/QtTextToSpeech/private/qttexttospeech-config_p.h
/usr/include/qt5/QtTextToSpeech/5.14.1/QtTextToSpeech/private/qvoice_p.h
...
/usr/lib64/libQt5TextToSpeech.so.5.14.1
