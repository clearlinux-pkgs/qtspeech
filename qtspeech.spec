...
Version  : 5.13.1
Release  : 13
URL      : https://download.qt.io/official_releases/qt/5.13/5.13.1/submodules/qtspeech-everywhere-src-5.13.1.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.13/5.13.1/submodules/qtspeech-everywhere-src-5.13.1.tar.xz
...
%prep
%setup -q -n qtspeech-everywhere-src-5.13.1
...
%install
export SOURCE_DATE_EPOCH=1568399486
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtTextToSpeech/5.13.1/QtTextToSpeech/private/qtexttospeech_p.h
/usr/include/qt5/QtTextToSpeech/5.13.1/QtTextToSpeech/private/qvoice_p.h
...
/usr/lib64/libQt5TextToSpeech.so.5.13.1
